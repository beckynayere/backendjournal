...
let JournalEntry = (() => {
    ...
    var JournalEntry = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_classThis, "JournalEntry");
    (() => {
        var _a;
        ...
        _user_decorators = [(0, typeorm_1.ManyToOne)(() => User_1.User, (user) => user.entries)];
        ...
        JournalEntry = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return JournalEntry = _classThis;
})();
