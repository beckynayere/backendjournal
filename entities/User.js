...
let User = (() => {
    ...
    var User = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.entries = (__runInitializers(this, _password_extraInitializers), __runInitializers(this, _entries_initializers, void 0));
    ...
    (() => {
        ...
        _username_decorators = [(0, typeorm_1.Column)(), (0, class_validator_1.Length)(4, 20)];
        _email_decorators = [(0, typeorm_1.Column)(), (0, class_validator_1.IsEmail)()];
        _password_decorators = [(0, typeorm_1.Column)(), (0, class_validator_1.Length)(8, 100)];
        _entries_decorators = [(0, typeorm_1.OneToMany)(() => JournalEntry_1.JournalEntry, (entry) => entry.user)];
